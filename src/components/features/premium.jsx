            ...
            <div>
                ...
                <div className=" w-11/12 max-w-[1380px] mx-auto flex ">
                    ...
                    <div className="w-1/2 ">
                        ...
                        <div className="absolute z-20 flex flex-col space-y-12 ">
                            <div className="mt-6 ">
                                ...
                                <p className="mt-4 text-gray-500 ">
                                    ...
                                    adipisicing elit. Temporibus cumque
                                    suscipit, obcaecati consequuntur doloremque
                                    veritatis dolorum tempore ea in vel?
                                </p>
                            </div>
                            <div className="mt-6 ">
                                <div className="flex items-center gap-x-3 ">
